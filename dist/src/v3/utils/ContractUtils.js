...
exports.setContractDefaults = exports.getFairGasPrice = void 0
var bignumber_js_1 = __importDefault(require('bignumber.js'))
function getFairGasPrice(web3, config) {
...
function setContractDefaults(contract, config) {
  if (config) {
...
exports.setContractDefaults = setContractDefaults
