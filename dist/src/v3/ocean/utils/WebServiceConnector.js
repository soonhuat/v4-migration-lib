...
var WebServiceConnector = (function () {
  ...
  WebServiceConnector.prototype.postWithOctet = function (url, payload) {
    var headers = {
      'Content-type': 'application/octet-stream'
    }
    return this.postWithHeaders(url, payload, headers)
  }
  WebServiceConnector.prototype.postWithHeaders = function (
    url,
    payload,
    headers
  ) {
    if (payload != null) {
      return this.fetch(url, {
        ...
        body: payload,
        headers: headers,
        signal: (0, Timeout_1.default)(this.requestTimeout)
      })
    } else {
      return this.fetch(url, {
        method: 'POST',
