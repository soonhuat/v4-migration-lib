...
exports.signWithHash = exports.signHash = exports.signText = void 0
var Logger_1 = require('./Logger')
function signText(web3, text, publicKey, password) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 3:
          ...
          Logger_1.LoggerInstance.warn('Error on personal sign.')
          Logger_1.LoggerInstance.warn(e_1)
          _a.label = 4
        case 4:
          _a.trys.push([4, 6, , 7])
...
function signHash(web3, message, address) {
  return __awaiter(this, void 0, void 0, function () {
    var signedMessage, r, s, v
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
...
function signWithHash(web3, text, publicKey, password) {
  return __awaiter(this, void 0, void 0, function () {
    var hash, isMetaMask, e_2, e2_2
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          hash = web3.utils.utf8ToHex(text)
          isMetaMask =
            web3 && web3.currentProvider && web3.currentProvider.isMetaMask
          _a.label = 1
        case 1:
        ...
        case 3:
          ...
          Logger_1.LoggerInstance.warn('Error on personal sign.')
          Logger_1.LoggerInstance.warn(e_2)
          _a.label = 4
        case 4:
          _a.trys.push([4, 6, , 7])
...
exports.signWithHash = signWithHash
